...
const experience: JCard[] = [
  { num: "01", name: "CyberAlliance", logo: "/logos/cyberalliance.png", role: "Cyber Security Product Manager", badge: "Current", dates: "Jun 2026 – Present", location: "Raleigh, NC", tags: ["Security PM", "AI Tooling", "Threat Intel", "Roadmap"], points: ["Driving security product roadmap with AI-powered PM tooling", "Enterprise threat intelligence product strategy"] },
  { num: "02", name: "Qualys", logo: "/logos/qualys.png", role: "QA Engineer", badge: "Full-time", dates: "Apr 2024 – Jul 2025", location: "Pune · Hybrid", tags: ["VMDR", "API Design", "Python / Perl"], points: ["22% reduction in false positives across 35+ enterprise accounts", "30% faster patch remediation via RICE-prioritized backlog", "40% cut in release validation via custom automation analytics"] },
  { num: "03", name: "ShellStrong Technologies", logo: "/logos/shellstrong.png", logoBg: "#0a2418", role: "Digital Forensic Intern", badge: "Internship", dates: "Jul 2023 – Dec 2023", location: "Pune · On-site", tags: ["DFIR", "AXIOM", "Cellebrite", "UFED"], points: ["60+ live forensic cases alongside government agencies", "95% stakeholder confidence across law enforcement investigations", "~20% investigation rework reduction via standardized workflows"] },
  { num: "05", name: "Pune Metro Rail Project", logo: "/logos/pune-metro.png", role: "Security Intern", badge: "Internship", dates: "Jun 2022 – Aug 2022", location: "Pune · On-site", tags: ["Security Audit", "Infrastructure", "Big Data"], points: ["10,000+ passenger records analyzed, identified process gaps", "Security baseline documentation adopted by operations team", "Big data infrastructure and security protocol analysis"] },
];
const certs: JCard[] = [
